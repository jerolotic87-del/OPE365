...
**Progreso de la reescritura**: `archivo` 308/410 — hechos
`opciones-avz-edicion` y `opciones-avz-pegar`. Quedan 102: los cinco bloques
`opciones-avz-*` restantes, `opciones-personalizar` y
