...
**Progreso de la reescritura**: `archivo` 278/410 — cerrados enteros todos
los topics salvo `opciones-avz-*`, `opciones-personalizar` y
`opciones-complementos`. Quedan 132 preguntas.
