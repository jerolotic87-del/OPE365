...
la incorporación de un bloque nuevo, p.ej. vista.json). build.py sigue
empaquetando el HTML final a partir de questions_all.json, así que este
script es el paso previo cuando se toca contenido de preguntas.
